...
import { Task, Priority, TaskStatus } from "@/store/taskStore"
  ...
  useEffect(() => {
    if (open) {
      ...
      if (task) {
        ...
        setCustomStatusId(task.customStatusId || null)
      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-task-description">描述（备忘）</Label>
              <Textarea
            ...
            {customStatuses.length > 0 && (
              <div className="grid gap-2">
                <Label htmlFor="edit-task-customStatus">自定义状态（可选）</Label>
                <Select
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label htmlFor="edit-task-dueDate">截止日期</Label>
                <Input
              ...
              <div className="grid gap-2">
                <Label htmlFor="edit-task-tags">标签（逗号分隔）</Label>
                <Input
                  id="edit-task-tags"
                  value={tags}
